/*
    ...
    Smoke test for corelib/dbj_defer.h, corelib/dbj_result.h,
    corelib/dbj_simple_log.h, corelib/dbj_macros.h and
    corelib/dbj_clintro.h -- confirms the five compose: a CLI intro
    ...
    Build (GCC 15+ required, see dbj_required_compile_time.h):
        gcc -std=c23 -Wall -Wextra -Wswitch -Werror -I. -o corelib_smoke_test.exe corelib_smoke_test.c
*/
...
{
    dbj_clintro("corelib_smoke_test", "0.1.0");
