...
> [!important]The model is the instantiation, the LLM is the paradigm.
>
## The Harness

> Claude code cli app is actually what we call today HARNESS.
...
>
> - **Theoria mundi architectorum** — "the architects' theory of the world" (pure genitive chain), or
>
> - **Theoria de mundo architectorum** — "a theory about the architects' world" (de + ablative)
>
> As a motto (for DBJ.METHOD or similar), the irregularity reads fine as a title/aphorism.
